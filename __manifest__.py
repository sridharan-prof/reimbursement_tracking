{
    ...
    'assets': {
        ...
        'web.assets_frontend': [
            ...
            'reimbursement_tracking/static/src/css/employee_department.css',
            'reimbursement_tracking/static/src/css/employee_detail.css',
            'reimbursement_tracking/static/src/js/employee_departments.js',
            'reimbursement_tracking/static/src/js/employee_detail.js',
            'reimbursement_tracking/static/src/xml/employee_departments.xml',
        ],
    },
    'application': True,
    'installable': True,
